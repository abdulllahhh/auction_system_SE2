  ...
  <header class="main-header clearfix" role="header">
    ...
    <nav id="menu" class="main-nav" role="navigation">
      <ul class="main-menu">
        ...
        <li><a href="Register.php" class="external">REGISTER</a></li>
      </ul>
    </nav>
  </header>
      ...
      <div class="row">
        <div class="col-md-7 col-xs-12">
          <div class="continer centerIt">
            <div>
              <h4>Welcom back get ready for <em>The christimas gifts</em> and start collecting rare products</h4>
              <div class="counter">
        ...
        <div class="col-md-5">
          <div class="right-content">
            ...
            <form id="contact" action="php/controller/LoginController.php" method="post">
              <div class="row">
                ...
                <div class="col-md-12">
                  <fieldset>
                    <button type="" id="form-submit" name="submit" class="button"><input class="submit" type="submit" value="Login" name="submit"></button>
                  </fieldset>
                </div>
              </div>
            </form>
